...
python train_fer.py --model ResNet18 --kd_T 5 --dataset cifar100 -s 7 --mu 1.0 #seed 7
...
python train_fer.py --model MobileNetV2 --kd_T 5 -s 5 --mu 0.3
python train_fer.py --model MobileNetV2 --kd_T 5 -s 7 --mu 0.3
